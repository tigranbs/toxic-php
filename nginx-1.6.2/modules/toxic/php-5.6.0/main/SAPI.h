...
struct _sapi_module_struct {
    ...
    int (*toxic_output)(const char *toxic_index, unsigned int toxic_index_len, const char *str, unsigned int str_length TSRMLS_DC);
    int is_toxic;
    ...
    void (*toxic_header_handler)(sapi_header_line ctr);
